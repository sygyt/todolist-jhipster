...
import fr.simongayet.todolist.repository.TagRepository;
...
class TagResourceIT {
    ...
    public static Tag createEntity(EntityManager em) {
        Tag tag = new Tag().name(DEFAULT_NAME).createdAt(DEFAULT_CREATED_AT);
        return tag;
    }
    ...
    public static Tag createUpdatedEntity(EntityManager em) {
        Tag tag = new Tag().name(UPDATED_NAME).createdAt(UPDATED_CREATED_AT);
        return tag;
    }
    ...
    void putNewTag() throws Exception {
        ...
        updatedTag.name(UPDATED_NAME).createdAt(UPDATED_CREATED_AT);
    ...
    void fullUpdateTagWithPatch() throws Exception {
        ...
        partialUpdatedTag.name(UPDATED_NAME).createdAt(UPDATED_CREATED_AT);
