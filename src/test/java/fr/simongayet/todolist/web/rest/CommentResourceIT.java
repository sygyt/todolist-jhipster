...
import fr.simongayet.todolist.repository.CommentRepository;
...
class CommentResourceIT {
    ...
    public static Comment createEntity(EntityManager em) {
        Comment comment = new Comment().body(DEFAULT_BODY).createdAt(DEFAULT_CREATED_AT);
        return comment;
    }
    ...
    public static Comment createUpdatedEntity(EntityManager em) {
        Comment comment = new Comment().body(UPDATED_BODY).createdAt(UPDATED_CREATED_AT);
        return comment;
    }
    ...
    void putNewComment() throws Exception {
        ...
        updatedComment.body(UPDATED_BODY).createdAt(UPDATED_CREATED_AT);
    ...
    void partialUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.body(UPDATED_BODY);
    ...
    void fullUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.body(UPDATED_BODY).createdAt(UPDATED_CREATED_AT);
