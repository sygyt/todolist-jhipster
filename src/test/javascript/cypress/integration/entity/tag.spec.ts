...
describe('Tag e2e test', () => {
  ...
  const tagSample = { name: 'sensor', createdAt: '2021-10-22T03:26:58.163Z' };
  ...
  describe('new Tag page', () => {
    ...
    it('should create an instance of Tag', () => {
      cy.get(`[data-cy="name"]`).type('quantify methodologies').should('have.value', 'quantify methodologies');

      cy.get(`[data-cy="createdAt"]`).type('2021-10-22T07:53').should('have.value', '2021-10-22T07:53');
