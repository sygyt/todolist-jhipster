package fr.simongayet.todolist.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, fr.simongayet.todolist.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, fr.simongayet.todolist.repository.UserRepository.USERS_BY_EMAIL_CACHE);
